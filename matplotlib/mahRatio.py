...
def linegraph(location, title):
  ...
  txPowerLabels = list(TX_POWERS_LABELS.values())

  ascon128a_lines = plt.plot(txPowerLabels, ascon128a_ratios, 'o:',
                            color=cipherToColor['ASCON-128a'],
                            label='ASCON-128a')
  ascon128_lines = plt.plot(txPowerLabels, ascon128_ratios, 'o-.',
                            color=cipherToColor['ASCON-128'],
                            label='ASCON-128')
  aes_lines = plt.plot(txPowerLabels, aes_ratios, 'o--',
